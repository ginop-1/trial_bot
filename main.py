# bot.py
import os, random
import wikipedia_for_humans, discord, re
...
async def join(ctx):
    ...
    connected.play(discord.FFmpegPCMAudio(source='./sounds/user-joined-your-channel.mp3'),)

@bot.command(name="leave")
async def leave(ctx):
    guild = ctx.guild
    voice_client: discord.VoiceClient = discord.utils.get(bot.voice_clients, guild=guild)
    audio_source = discord.FFmpegPCMAudio(source='./sounds/teamspeak_disconnect.mp3')
